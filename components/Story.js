                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4 ">
                    {
                        storyData.map((value, index, array) => {
                            return (
                                ...
                                <div className="max-w-sm mx-auto bg-white text-black " key={index}>
                                    <Image
                                        src={value.img}
                                        alt={value.name}
                                    ...
                                    <div className="p-5">
                                        ...
                                        <button type='button' className="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-black bg-yellow rounded-lg hover:bg-yellow focus:ring-4 focus:outline-none focus:ring-yellow dark:bg-yellow dark:hover:bg-yellow dark:focus:ring-yellow">
                                            Read more
